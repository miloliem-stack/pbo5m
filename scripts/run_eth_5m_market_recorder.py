...
from src.market_router_eth_5m import route_eth_5m_market
from src.runtime.market_recorder import MarketRecorderRuntime


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the ETH-5m Polymarket market recorder")
    parser.add_argument("--output-dir", default="artifacts/market_recorder_eth")
